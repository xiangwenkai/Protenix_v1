...
model_configs = {
    ...
    "model": {
        ...
        "cross_pair_proposal": {
            ...
            "slot_attn_heads": 4,
            "delta_scale": 1.0,
            "head_slot_init": "random",
            "head_slot_init_scale": 1.0,
            "token_hidden_dim": 64,
            "use_content_branch": True,
            "use_geometry_branch": True,
            "use_pair_bio_feat": True,
            "use_pair_geom_feat": True,
            "content_logit_scale": 1.0,
            "bio_pair_feat_scale": 1.0,
            "geom_pair_feat_scale": 1.0,
            "num_content_slot_bank": 4,
            "content_prior_hidden_dim": GlobalConfigValue("c_z"),
            "content_prior_bias_scale": 1.0,
            "content_delta_scale": 1.0,
            "geometry_delta_scale": 1.0,
            "freeze_geometry_for_head0": True,
            "gate_floor": 0.1,
            "random_branch_diffusion_batch_size": 8,
...
loss_configs = {
    "loss": {
        ...
        "weight": {
            ...
            "alpha_cross_pair_charge": 0.0,
            "alpha_cross_pair_patch_smoothness": 0.0,
        ...
        "cross_pair_charge": {
            "enable": False,
            "pooling": "max",
            "positive_target": 0.35,
            "negative_target": 0.15,
            "margin": 0.10,
            "histidine_weight": 0.5,
            "softplus_temperature": 0.05,
            "reduction": "mean",
            "eps": 1e-6,
        },
        "cross_pair_patch_smoothness": {
            "enable": False,
            "use_probs": True,
            "protein_weight": 1.0,
            "rna_weight": 1.0,
