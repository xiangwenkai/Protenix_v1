...
eclip_ppft_configs = {
    "eclip_ppft": {
        ...
        "protein_msa_map_json": "output/eclip_protein_msa/protein_msa_map.top512.json",
        "protein_msa_pair_as_unpair": True,
        "protein_msa_use_rna_msa": False,
        "use_cell_condition": False,
        "cell_condition_dim": 128,
        "cell_condition_target": "rna",
        "train_split": "train",
