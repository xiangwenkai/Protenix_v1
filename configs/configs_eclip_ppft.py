...
eclip_ppft_configs = {
    "eclip_ppft": {
        ...
        "n_rollout_steps": 20,
        "record_grad_steps": ListValue([0]),
        "detach_unrecorded_steps": True,
        "n_cycle": DefaultNoneWithType(int),
        "inplace_safe": False,
        "diffusion_attn_chunk_size": DefaultNoneWithType(int),
        "binding_cutoff": 5.0,
        "binding_temperature": 0.5,
        "binding_softmin_beta": 4.0,
        "binding_protein_atom_chunk_size": 4096,
        "learn_binding_temperature": False,
        "learn_binding_softmin_beta": False,
        "signal_profile_weight": 5.0,
        "signal_positive_weight": 5.0,
        "signal_point_weight": 1.0,
        "signal_loss_weight": 1.0,
        "confidence_quality_weight": 1.0,
        "confidence_quality_target": 0.8,
        "confidence_monitor_clash": True,
        "sidecar_lr": 1e-4,
        "train_sidecar": False,
        "train_stage": "diffusion",
        "train_last_diffusion_blocks": 4,
        "train_last_pairformer_blocks": 0,
